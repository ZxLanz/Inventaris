{{-- resources/views/barang/partials/_form.blade.php --}}
...
<div class="row g-3">
    ...
    <div class="col-md-6">
        ...
        <input type="date" 
               ...
               value="{{ old('tanggal_pengadaan', isset($barang) && $barang->tanggal_pengadaan ? $barang->tanggal_pengadaan->format('Y-m-d') : date('Y-m-d')) }}" 
               required>
